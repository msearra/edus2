...
if [ $# -ne 2 ]; then
  ...
  ffmpeg -vf "crop=520:430:80:24, scale=-1:480, drawtext=fontfile=/opt/local/share/fonts/dejavu-fonts/DejaVuSans.ttf: text='Test':x=5: y=450: fontsize=16: fontcolor=white@0.8: box=1: boxcolor=black@0.8" -sameq -i "$1"  "$2"
